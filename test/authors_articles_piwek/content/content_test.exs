defmodule AAPiwek.ContentTest do
  ...
  describe "articles" do
    ...
    test "list_articles/0 returns all articles" do
      ...
      assert Content.list_articles_ass() == [article]
    end

    test "get_article!/1 returns the article with given id" do
      article = article_fixture()
      assert Content.get_article_ass!(article.id) == article
    end
    ...
    test "delete_article/1 deletes the article" do
      ...
      assert_raise Ecto.NoResultsError, fn -> Content.get_article_ass!(article.id) end
    end
